...
DONEZO - The compiler can't compile the "pi.calc" test file. This file should be possible to compile to be given a passing grade.

DONEZO - The "looptest.calc" do not produce the correct output. It outputs only 1s in a loop that never ends. 
